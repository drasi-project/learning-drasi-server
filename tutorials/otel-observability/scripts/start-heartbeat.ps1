...
Write-Host "Resuming checkout heartbeats via $checkoutUrl"
Invoke-RestMethod -Method Post -Uri "$checkoutUrl/heartbeat/on" | ConvertTo-Json
Write-Host ""
Write-Host "The missing-heartbeat result should be Removed."
