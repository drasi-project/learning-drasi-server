...
Write-Host "Stopping checkout heartbeats via $checkoutUrl"
Invoke-RestMethod -Method Post -Uri "$checkoutUrl/heartbeat/off" | ConvertTo-Json
Write-Host ""
Write-Host "After ~10s the missing-heartbeat query should emit Added."
