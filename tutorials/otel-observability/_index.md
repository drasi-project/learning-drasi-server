...
linkTitle: "OTel Observability"
weight: 40
description: >
  Correlate a Kubernetes rollout, OpenTelemetry health, and a PostgreSQL SLO policy with continuous graph queries and the dashboard reaction.
---
...
<div class="flow-diagram">
  <div class="flow-step">
    ...
    <div class="flow-step__description">Kubernetes, OTel, and PostgreSQL</div>
  </div>
  ...
  <div class="flow-step">
    ...
    <div class="flow-step__description">Correlate rollout, health, and policy</div>
  </div>
  ...
  <div class="flow-step">
    ...
    <div class="flow-step__description">Dashboard and console log</div>
  </div>
</div>
...
{{% alert title="The OTel source plugin" color="warning" %}}
...
### Loading a local OTel plugin {#local-plugin}
