...
weight: 40
description: >
  Build a no-code, real-time dashboard over two different databases - a PostgreSQL orders store and a SQL Server vehicles store - joined by license plate, with a terminal app to drive the changes.
---
...
| **[Step 2: Run the Demo](#run)** | One command starts both databases and Drasi Server |
| **[Step 3: Open the Dashboard](#dashboard)** | Watch all four panels update live |
| **[Step 4: Drive Change](#drive)** | Use the terminal app to change orders and vehicles, and watch Drasi react |
| **[How It Works](#how)** | Understand the two sources, the cross-database join, and the four queries |
...
{{% alert title="Known issue: the Vehicles list" color="warning" %}}
...
{{% alert title="Why updated_at?" color="info" %}}
