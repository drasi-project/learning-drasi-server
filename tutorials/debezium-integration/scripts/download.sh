...
# Pinned to 0.2.3 so source/kafka and friends resolve to SDK ABI 0.13 plugins.
# Configs pin: source/http:0.2.11, source/kafka:0.1.7, reaction/dashboard:0.1.5,
# reaction/log:0.2.7. Newer "latest" plugins (e.g. kafka 0.1.8) need host ABI 0.14.
